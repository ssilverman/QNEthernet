    ...
    [](const altcp_allocator_t *allocator) {
      ...
      if (allocator->alloc == &altcp_tls_alloc) {
        ...
        if (config != nullptr) {
          ...
          printf("qnethernet_altcp_free_allocator: config is NULL\r\n");
        }
      }
#endif  // LWIP_ALTCP_TLS && LWIP_ALTCP_TLS_MBEDTLS
    };
